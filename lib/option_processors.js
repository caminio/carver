(function(){
  ...
  module.exports.cwd = function( cwd, compiler ){
    ...
    compiler.options = _.merge( compiler.options, require( configPath ) );
  ...
  module.exports.doc = function( doc, compiler ){
    ...
    if( compiler.options.doc[compiler.options.filenameKey] )
      compiler.options.filename = compiler.options.doc[compiler.options.filenameKey];

    if( !_.isEmpty(compiler.options.doc[compiler.options.templateKey]) )
      compiler.options.template = compiler.options.doc[compiler.options.templateKey];
