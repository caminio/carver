module.exports = function render( Carver ){
  ...
  Carver.prototype.render = function render( content, lang ){
    ...
    if( compiler.options.doc || compiler.options.cwd ){
      compiler.options.locals.filename = compiler.options.doc ? compiler.options.doc.filename : (compiler.options.template || compiler.options.filename);
      compiler.options.locals.urlNoLang = join('/',(compiler.options.doc ? compiler.options.doc.url : compiler.options.locals.filename));
