module.exports = function Writers( Carver ){
  ...
  Carver.prototype.contentLangWriter = function contentLangWriter( lang ){
    ...
    function renderTemplateFile(){
      ...
      return compiler.render( templateRaw, 'utf8' );
    }
    ...
    function writeToDrafts(content){
      ...
      var filename = compiler.options.doc[compiler.options.primaryKey];
      return checkAndWrite( compiler.options.drafts, content, { filename: filename } );
    }
